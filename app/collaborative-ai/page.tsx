    ...
    <PageContainer title="Collaborative AI">
      ...
      >
        ...
        <div className="absolute top-1/4 left-0 text-blue-200 dark:text-blue-900/30 opacity-20 pointer-events-none transform rotate-12">
          <BlobShape width={250} height={250} />
        </div>
      ...
      >
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {thoughtLeadershipPosts.map((post, index) => (
              <div 
                key={index}
          ...
          <div className="mt-12 text-center">
            <Link 
              href="/insights"
              className="bg-white dark:bg-gray-800 border border-blue-600 text-blue-600 px-6 py-3 rounded-md font-medium hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors inline-flex items-center"
            >
              View all insights
              <HiArrowLongRight className="ml-2 w-5 h-5" />
            </Link>
