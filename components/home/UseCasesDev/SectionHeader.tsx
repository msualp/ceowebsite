...
import { ColorName, colorClasses } from '../useCases/types';
...
const SectionHeader: React.FC<SectionHeaderProps> = ({
  ...
  return (
    <div className={`text-center mb-8 md:mb-16 px-4 md:px-6 w-full transition-opacity duration-300 ${uiReady ? 'opacity-100' : 'opacity-0'}`}>
