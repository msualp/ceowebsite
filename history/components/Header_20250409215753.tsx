  ...
  return (
    <header className="sticky top-0 z-50 w-full backdrop-blur-md bg-white/30 dark:bg-black/30 transition-all duration-300">
      <div className="container mx-auto flex items-center justify-between px-4 py-2">
        <Link
          href="/"
          className="text-3xl font-extrabold tracking-tight font-serif hover:animate-gradient-x bg-gradient-to-br from-neutral-900 via-gray-600 to-neutral-900 dark:from-white dark:via-gray-300 dark:to-white bg-clip-text text-transparent transition-all duration-300"
        >
          Mustafa Sualp1
        </Link>
