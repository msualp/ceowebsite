      ...
      >
        ...
        <div className="p-4 space-y-4 flex-grow">
          <Link 
            ...
            className={`block text-lg flex items-center gap-3 ${pathname === '/about' ? 'text-blue-600 font-medium' : 'hover:underline'} cursor-pointer`}
          >
            <svg className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5.121 17.804A13.937 13.937 0 0112 16c2.5 0 4.847.655 6.879 1.804M15 10a3 3 0 11-6 0 3 3 0 016 0zm6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
          ...
          <Link 
            ...
            className={`block text-lg flex items-center gap-3 ${pathname === '/sociail' ? 'text-blue-600 font-medium' : 'hover:underline'} cursor-pointer`}
          >
            <svg className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" />
            </svg>
          ...
          <Link 
            ...
            className={`block text-lg flex items-center gap-3 ${pathname === '/journey' ? 'text-blue-600 font-medium' : 'hover:underline'} cursor-pointer`}
          >
            <svg className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <Link 
            ...
            className={`block text-lg flex items-center gap-3 ${pathname === '/insights' ? 'text-blue-600 font-medium' : 'hover:underline'} cursor-pointer`}
          >
            <svg className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <Link 
            ...
            className={`block text-lg flex items-center gap-3 ${pathname === '/resume' ? 'text-blue-600 font-medium' : 'hover:underline'} cursor-pointer`}
          >
            <svg className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
