...
export function Header() {
  ...
  return (
    <>
      ...
      <header className={`fixed top-0 left-0 right-0 z-[100] transition-transform duration-300 ${isVisible ? 'translate-y-0' : '-translate-y-full'} backdrop-blur-sm bg-white/60 dark:bg-black/30 border-b border-white/10`}>
      ...
      >
        ...
        <div className="p-4 space-y-4 flex-grow">
          ...
          <Link 
            href="/contact" 
            onClick={toggleMenu} 
            className={`block text-lg flex items-center gap-3 transition-transform duration-300 hover:scale-[1.02] ${pathname === '/contact' ? 'text-blue-600 font-medium' : 'hover:underline'}`}
