...
export function Header() {
  ...
  return (
    <header className="w-full border-b border-gray-200 dark:border-gray-700 backdrop-blur-md bg-white/30 dark:bg-black/30">
      <div className="container mx-auto flex items-center justify-between px-4 py-4">
        <Link href="/" className="text-2xl font-bold bg-gradient-to-r from-gray-900 via-gray-700 to-gray-900 dark:from-white dark:via-gray-300 dark:to-white bg-clip-text text-transparent">
          Mustafa Sualp
        </Link>
