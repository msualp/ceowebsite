...
export function Header() {
  ...
  return (
    <header className="w-full backdrop-blur-md bg-white/30 dark:bg-black/30">
      <div className="container mx-auto flex items-center justify-between px-4 py-2">
        <Link
          href="/"
          className="text-3xl font-extrabold tracking-tight bg-gradient-to-br from-neutral-900 via-gray-600 to-neutral-900 dark:from-white dark:via-gray-300 dark:to-white bg-clip-text text-transparent"
        >
          Mustafa Sualp
        </Link>
