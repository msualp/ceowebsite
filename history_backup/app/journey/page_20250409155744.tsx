    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="prose dark:prose-invert max-w-none">
        ...
        <div className="relative border-l-4 border-blue-500 pl-8 py-4 mb-12">
          ...
          <p className="text-sm text-gray-500 mb-2">March 2023 - Present</p>
          <p>
        ...
        <div className="relative border-l-4 border-blue-500 pl-8 py-4 mb-12">
          ...
          <p className="text-sm text-gray-500 mb-2">September 2021 - June 2022</p>
          <p>
        ...
        <div className="relative border-l-4 border-blue-500 pl-8 py-4 mb-12">
          ...
          <p className="text-sm text-gray-500 mb-2">October 2012 - June 2022</p>
          <p>
        ...
        <div className="relative border-l-4 border-blue-500 pl-8 py-4 mb-12">
          ...
          <p className="text-sm text-gray-500 mb-2">April 1999 - December 2017</p>
          <p>
        ...
        <div className="relative border-l-4 border-blue-500 pl-8 py-4 mb-12">
          ...
          <p className="text-sm text-gray-500 mb-2">1996 - 2009</p>
          <p>
        ...
        <div className="grid gap-6 mb-12">
          <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
            ...
            <p className="text-sm text-gray-500 mb-2">January 2023 - May 2023</p>
          ...
          <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
            ...
            <p className="text-sm text-gray-500 mb-2">August 1994 - June 1999</p>
